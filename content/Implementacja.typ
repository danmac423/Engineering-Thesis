...
<kafelkowanie-przestrzenne>
Kafelkowanie jest wykonalne dzięki własności odziedziczonej po implementacji referencyjnej: bufory pamięci podręcznej kluczy i wartości inicjalizowane są wartością pustą na początku każdego wywołania potoku, więc każde wywołanie stanowi niezależny przebieg strumieniowy. Fragmenty klatki można zatem przetwarzać bez współdzielenia stanu między nimi.
