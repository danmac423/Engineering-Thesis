...
#figure(
  ...
  caption: flex-caption(
    [
      Kafelkowanie przestrzenne: (a) podział klatki na kafle z zaznaczonymi obszarami nakładania, (b) cofnięcie kafla wykraczającego poza krawędź klatki, (c) maski mieszania poszczególnych kafli i suma ich wag. Przykład odpowiada wejściu $448 times 256$ pikseli, kaflowi 192 piksele i zakładce 24 piksele
    ],
