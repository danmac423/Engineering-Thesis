...
Kluczową decyzją projektową jest utrzymywanie wyniku w pamięci operacyjnej, a nie w pamięci karty graficznej. Na karcie znajdują się jednocześnie wyłącznie wagi modelu, pamięć podręczna kluczy i wartości oraz aktywacje jednego kafla. Dzięki temu szczytowe zużycie pamięci karty zależy od rozmiaru kafla, a nie od rozdzielczości nagrania wejściowego.
