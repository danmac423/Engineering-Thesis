...
Celem pracy jest umożliwienie inferencji jednokrokowego, dyfuzyjnyego modelu superrozdzielczości wideo na karcie graficznej wyposażonej w 10 GB pamięci VRAM, przy zachowaniu akceptowalnych jakości rekonstrukcji i czasu przetwarzania. Jako model bazowy przyjęto _FlashVSR_ @Zhuang2025FlashVSRTR.
