...
W pracy skupiono się na inferencji modelu, bez wykonywania dodatowego treningu ani dostrajania parametrów, z wykorzystaniem publicznie udostępnionych wag. Głównym wkładem pracy jest adaptacja istniejącego modelu do środowiska o ograniczonych zasobach oraz zbadanie kompromisów między jakością rekonstrukcji, czasem inferencji a zużyciem pamięci.
