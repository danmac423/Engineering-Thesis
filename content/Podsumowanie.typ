...
Spadek jakości rekonstrukcji wynika niemal wyłącznie z zastosowania kafelkowania. Jak wynika z analizy łańcucha przyrostowych konfiguracji, to właśnie wprowadzenie kafelkowania odpowiada za całą zmianę metryki PSNR oraz za większość spadków w pozostałych wskaźnikach. Trzy kolejne modyfikacje obliczeniowe zmieniają wyniki w sposób marginalny. Oznacza to, że kompromis między jakością obrazu a zużyciem pamięci sprowadza się w~praktyce do decyzji o kafelkowaniu, a nie do wyboru poszczególnych technik obliczeniowych.
